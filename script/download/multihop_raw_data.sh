...
wget http://curtis.ml.cmu.edu/data/hotpot/hotpot_train_v1.1.json -O data/raw_data/hotpotqa/hotpot_train_v1.1.json
wget http://curtis.ml.cmu.edu/data/hotpot/hotpot_dev_distractor_v1.json -O data/raw_data/hotpotqa/hotpot_dev_distractor_v1.json
...
wget https://iirc-data.s3.us-west-2.amazonaws.com/iirc_train_dev.tgz -O .temp/iirc_train_dev.tgz
...
wget https://iirc-data.s3.us-west-2.amazonaws.com/context_articles.tar.gz -O .temp/context_articles.tar.gz
